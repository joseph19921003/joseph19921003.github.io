...
function h(a, b) { //启发函数
	var cross = 0;
	if(dotTiebreaker) { //计算初始-目标向量和当前-目标向量之间的向量叉积;这段代码选择的路径稍微倾向于沿着初始点到目标点的直线路径
		var dx1 = a.x - b.x
		var dy1 = a.y - b.y
		var dx2 = start.x - b.x
		var dy2 = start.y - b.y
...
function pathFind(x, y, x2, y2) {
	...
	var g_score = {}; // distance from start along optimal path 开始沿着最优路径的距离
	var f_score = {}; // estimated distance from start to goal through node 开始到目标节点的估计距离
